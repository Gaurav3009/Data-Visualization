...
public class FileController {
	...
	@PostMapping("/upload")
	public ResponseEntity<FileResponse> fileUpload(@RequestParam("csv") MultipartFile file, @RequestParam("graphName") String graphName) {
		try {
			...
			return new ResponseEntity<>(new FileResponse(null, "File is not uploaded due to error on server!!"), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
